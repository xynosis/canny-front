...
header.z-max.w-100(
  ...
  nav.dt.ph4.font-canny-dark.pv3.center
    ...
    .dtc.tr.canny-header.v-mid(  v-if="$store.getters['settings/isMobile']")
      .pointer.z-max.pr2.link.f3.tr.flex(
        @click="openMenu()",
    ...
    .canny-header.db.dtc-l.tl-l.v-mid.static-l.mt5.mt0-l.tr.pl4(
      ...
      .pt2.pt0-l.f2.f4-l.tr.tl-l
        ...
        nuxt-link.dib-l.pv4(to="/cart")
          ...
          .white.link.f2.f4-l.dib.ph2 Cart (0)
        nuxt-link.dib-l(to="/account")
          font-awesome-icon.dib.ph2.f4-l.f2.font-canny-yellow(icon="user")
          //- .white.link.f5.f4-l.dib.ph2 Cart ({{ getCart.items.length }})
          .white.link.f2.f4-l.dib.ph2 Account

    nuxt-link.f3-l.f3.v-mid.dtc-ns.link.w-100.pl2(to="/", title="Home" :class="{ 'w-100': !$store.getters['settings/isMobile'], 'w-30-l':!$store.getters['settings/isMobile']  }") 
      .fr
  ...
  .tc.canny-header.white.center(
    ...
    .header.link.dib.ph4-l(v-if="viewMenu")
      #header-item.dib-l.dt-s.pointer.ma3.ph1.pb2.link.f4-l.f3.fw6(
        :title="items.title",
        v-for="items in nav",
      ...
      nuxt-link.dib-l(to="/account")
        ...
        .white.link.f3.f4-l.dib.ph2 Account
</template>
